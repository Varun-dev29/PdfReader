    ...
    >
      <div className="p-4">
        ...
        <nav className="space-y-1">
          <Link href="/">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
          ...
          <Link href="/recent">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/recent' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/bookmarks">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/bookmarks' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/refer">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/refer' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/redeem">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/redeem' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/settings">
            <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${location === '/settings' ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
